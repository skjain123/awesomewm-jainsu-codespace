...
-- beautiful.init(gears.filesystem.get_themes_dir() .. "/.cache/wal/colors.lua")
-- beautiful.init(os.getenv("HOME") .. "/.cache/wal/colors.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Main", "Terminal", "3", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
-- set up pipx 
awful.spawn.with_shell("eval '$(register-python-argcomplete pipx)'")
